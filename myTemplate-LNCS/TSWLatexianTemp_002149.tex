...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\subsection{Associated Challenges}
		...
		The migration process from a CDN to another is unecessarily difficult due to incompatibility between different CDN providers. The lack of standards pay a big role here that should be dealt with as soon as possible\cite{IPTV}.
