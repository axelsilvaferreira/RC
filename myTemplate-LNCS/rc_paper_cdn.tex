...
e-mail: \{afonsojoao96@gmail.com, a71655@alunos.uminho.pt, axelferreira@me.com
}
...
Modern (digital) networks are faster and more reliable, but most of the core protocols above don't take advantage of the increased reliability.\\
...
With the continuous Internet growth a response was necessary to solve the above problems and Content Delivery Networks started to emerge (in 95's)\dots 
...
\subsection{What are the Advantages?}
	...
	%-Redundancy (caso desastre natural, ex.: incendio uMinho)
	%-Absorve melhor ataques DDoS
	%-Cheap to get going (pay as you go) no need for big investment at beguinning
\subsection{What are the Desadvantages?}
...
\fi 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Âmbito de aplicação}								%(Afonso)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\if
	-Onde Colocar os servidores da CDN e Porquê?
...
\fi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Arquiteturas relevantes na área}						%(Axel)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
